  ...
  <v-navigation-drawer v-model="overview.drawer" class="pa-2">
    <template v-slot:prepend>
      <v-card class="py-10" flat>
        ...
        <v-card-text class="d-flex justify-center pb-0">Admin </v-card-text>
        <v-card-subtitle class="text-center text-caption pt-0">admin@getartizan.com</v-card-subtitle>
...
import { useArtizanOverviewStore } from '@/store/overview/overview'
